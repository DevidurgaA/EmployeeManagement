...
public class EmployeeController {
	private static final EmployeeServiceImplVersion2 EMPLOYEE_IMPL = new EmployeeServiceImplVersion2();
	...
	/**
	 * <p>
	 *     Shows the employee details that are available in
	 *     the database
	 * </p>
	 * 
	 */
	 ...
	 * @param employeeId
	 */
	public Employee searchEmployeeData(final int employeeId) {
		return EMPLOYEE_IMPL.selectEmployee(employeeId);
	}
	 ...
	 * @param userChoice
	 */
	public boolean choiceValidation(final String userChoice) {
